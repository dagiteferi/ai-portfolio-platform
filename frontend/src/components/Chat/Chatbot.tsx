...
const Chatbot = forwardRef<ChatbotHandle>((props, ref) => {
  ...
  return (
    <>
      ...
      >
        {isOpen ? <X className="w-5 h-5 text-foreground" /> : <MessageCircle className="w-5 h-5 text-white" />}
      </button>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex flex-col flex-grow min-w-0">
            {/* Header */}
            <div className="bg-gradient-to-r from-primary to-accent p-4 text-white flex justify-between items-center w-full rounded-t-xl flex-shrink-0">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-90">{activeConversation ? activeConversation.title : 'Ask about me'}</p>
                </div>
              </div>
